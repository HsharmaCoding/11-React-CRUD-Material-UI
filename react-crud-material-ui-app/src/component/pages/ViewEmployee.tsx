...
export const ViewEmployee=()=>{
    ...
    const [data,setData] = useState<IEmployee>({departmentId:0,firstName:"",lastName:"",email:"",gender:"",isPermanent:false,mobile:""});
    const {id} = useParams();
    ...
    useEffect(()=>{
        if(id!=null && id!=undefined && parseInt(id)!=0){
            const employee= employeeService.getEmployeeById(parseInt(id));
            setData(employee);
        }
    },[])
